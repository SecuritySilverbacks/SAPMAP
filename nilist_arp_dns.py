...
Problem:
  SAP dispatcher does getnameinfo(192.168.2.210) → "ubuntu.arnhem.chello.nl",
  then getaddrinfo("ubuntu.arnhem.chello.nl") → NXDOMAIN from SAP server's DNS.
...
Strategy:
  ...
  4. Sniff frames at L2 (AF_PACKET); intercept DNS UDP queries from SAP server:
       - ubuntu.arnhem.chello.nl A? → reply A=192.168.2.210
...
REVERSE_HOST = "ubuntu.arnhem.chello.nl"
