...
The SAP dispatcher does getnameinfo(192.168.2.210) → 'ubuntu.arnhem.chello.nl'
then tries getaddrinfo('ubuntu.arnhem.chello.nl') → NXDOMAIN → never connects.

This server:
  - Answers A  ubuntu.arnhem.chello.nl  → 192.168.2.210
...
REVERSE_HOSTNAME = "ubuntu.arnhem.chello.nl"
